...
export const productSubpages = [
  {
    ...
    seoTitle: 'MTU Part Number Lookup | Engine Family',
    h1Title: 'MTU Part Number Lookup',
    summary:
      'Send your MTU part number, engine model, serial number, or nameplate photo. Engine Family helps verify the correct genuine or OEM manufacturer replacement before quotation.',
    content: {
  ...
  },
  {
    ...
    seoTitle: 'MTU 2000 Series Marine Generator Parts | Engine Family',
  ...
  },
  {
    ...
    seoTitle: 'MTU 4000 Series Overhaul Parts | Engine Family',
    ...
    content: {
      partOne: `<h2>Overhaul Parts for MTU 4000</h2><p>MTU 4000 series engines are used where reliability and uptime matter. Engine Family supports maintenance teams with parts for cylinder-head work, piston and liner replacement, valve-train service, bearings, gaskets, seals, cooling, and fuel systems.</p><h3>Common Overhaul Categories</h3><ul><li>Pistons, liners, rings, bearings, and gaskets</li><li>Valves, guides, seats, and cylinder-head parts</li><li>Fuel pumps, injectors, sensors, and control items</li><li>Cooling, lubrication, turbocharging, and filtration components</li></ul>`,
  ...
  },
  {
    ...
    seoTitle: 'Cummins Service Kits and Overhaul Parts | Engine Family',
  ...
  },
  {
    ...
    seoTitle: 'DEUTZ Industrial Equipment Parts | Engine Family',
